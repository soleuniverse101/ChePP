...
public:
    ...
    [[nodiscard]] constexpr move_type_t type_of() const { return static_cast<move_type_t>(m_data & (3 << 14)); }

    [[nodiscard]] constexpr piece_type_t promotion_type() const { return static_cast<piece_type_t>((m_data >> 12 & 3) + KNIGHT); }
